...
while True:
  ...
  for each_word in list_of_words:
    ...
    if each_word == "bored":
      ...
      encouragement_list.append("to go find something interesting to do")
      counter += 1
    if each_word == "happy":
    ...
    if each_word == "tired":
      ...
      encouragement_list.append("to rest early")
      counter += 1
    if each_word == "sad":
      feelings_list.append("sad")
      encouragement_list.append("to cheer up, have fun and appreciate the small things in life")
      counter += 1
    if each_word == "scared":
